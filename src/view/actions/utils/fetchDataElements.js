...
import fetchFromReactor from "../../utils/fetchFromReactor";
import UserReportableError from "../../errors/userReportableError";

// delegateDescriptorId would be something like this: "adobe-alloy::dataElements::object-variable"
const fetchDataElements = async ({ orgId, imsAccess, propertyId, signal, delegateDescriptorIds }) => {
  let parsedResponse;
  ...
  while(true) {
    ...
    console.log(JSON.stringify(parsedResponse.parsedBody, null, 2));
  ...
  */
  ...
  matchingDataElements.sort((a, b) => a.name.localeCompare(b.name, 'en', { sensitivity: 'base' }));
