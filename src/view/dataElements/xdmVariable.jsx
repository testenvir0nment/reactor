...
const SandboxAndSchemaSelectors = ({ initInfo, formikProps, registerImperativeFormApi }) => {
  const {
    settings,
    company: { orgId },
    tokens: { imsAccess }
  ...
  if (cacheIdRef.current == null) {
    cacheIdRef.current = (settings && settings.cacheId) || uuid();
  }
...
SandboxAndSchemaSelectors.propTypes = {
  initInfo: PropTypes.object,
  formikProps: PropTypes.object,
  registerImerativeFormApi: PropTypes.func
};
...
const XdmVariable = () => {
  return (
    <ExtensionView
      render={props => (
        <SandboxAndSchemaSelectors {...props} />
      )}
    />
  );
};
