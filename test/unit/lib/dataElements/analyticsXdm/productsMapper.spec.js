...
describe("products", () => {
  ...
  it("parses multiple products with different quantities", () => {
    test(";Example product 1;9;26.91,Example category;Example product 2;4;9.96", {
      "productListItems": [
        {
          "name": "Example product 1",
          "quantity": 9,
  ...
  it("parses currency event1 only to product 2 and not product 1", () => {
    test(";Example product 1;1;1.99,Example category 2;Example product 2;1;2.69;event1=1.29", {
      "productListItems": [
        {
          "name": "Example product 1",
          "quantity": 1,
